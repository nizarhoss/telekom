...
def main():
    ...
    st.write("""
    I wanted to try vectorizing and indexing an LLM from my own subset of information. This can be scaled towards leveraging different bodies of text. A practical implementation may include using Whisper API to transcribe customer service interactions and indexing/vectorizing the conversations for internal customer service analytics.
    """)
